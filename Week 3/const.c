...
int main(void)
{
	...
	const int DAYS_IN_WEEK = 7;		// 4 바이트
	const float PI = 3.141592f;		// 4 바이트
	const double GRAVITY = 9.80665;	// 8 바이트
	...
	printf("1주일의 일: %d%c", DAYS_IN_WEEK, NEW_LINE);
	printf("내 피자의 영역: 12 inch * %.5f%c", PI, NEW_LINE);
